...
export default class ApiRepository {
  ...
  private static readonly _TV_GAMES_ID_ATTEMPTS = "/tvgames/{0}/attempts?pageLength=10&pageIndex={1}"
  ...
  public static readonly getListOfGuesser = (id: string, index: string): Promise<ApiResponse<ApiList<Tweet>>> =>
    ApiManager.get<ApiList<Tweet>>(this.stringFormat(this._BASE_URL + this._TV_GAMES_ID_ATTEMPTS, id, index))
