...
<template>
  <div class="bg-foreground shadow rounded-lg p-6" :style="`width: ${CHART_WIDTH+50}px; height: ${CHART_HEIGHT + 80}px`">
    ...
    <div v-if="!loading && chartOptions.series.length === 0" class="flex flex-col w-full h-full items-center justify-center">
