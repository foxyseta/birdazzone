...
<template>
  ...
  >
    <div class="flex flex-row flex-1 w-full">
      ...
      <button
        class="btn rounded-lg bg-foreground hover:bg-lgray/50 p-4 flex-1"
      ...
      >
        ...
        >
          ...
          <div class="flex flex-col mx-4">
            <div
              class="flex"
              style="flex: 1 1 auto; height: 2rem"
            >
              <img
                v-if="index === 1"
        ...
        >
          <div
            id="bodyTweet"
            class="flex flex-1 text-white"
          >
            {{ props.data.text }}
          </div>
          <div
            id="paramTweet"
            class="flex flex-row mt-1 text-lgray"
            style="justify-content: left; max-height: 1.5rem"
          >
            ...
            <div class="flex flex-row mr-2">
              ...
              />
              {{ props.data.metrics.retweetCount }}
            </div>
