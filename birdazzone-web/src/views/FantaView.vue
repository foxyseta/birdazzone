<script lang="ts" setup>
  ...
  const showPoliticians = () => {
    showPoliticiansTab.value = true;
    showTeamsTab.value = false;
  };

  const showTeams = () => {
    showPoliticiansTab.value = false;
    showTeamsTab.value = true;
  };
</script>
  ...
  <div class="pl-4 w-screen flex flex-col justify-start">
    <div class="flex flex-row">
      ...
      <div
        ...
        style="flex: 1 1 auto; text-align: center; max-width: 19rem"
      >
        FANTACITORIO
      </div>
      <div
    ...
    <div class="flex justify-start w-100 m-3">
      <BirdazzoneButton
        :text="'POLITICIANS'"
        :active="showPoliticiansTab"
        @click="showPoliticians"
      ></BirdazzoneButton>
      <BirdazzoneButton
        :text="'TEAMS'"
        :active="showTeamsTab"
